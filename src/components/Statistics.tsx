...
function Statistics() {
  const count = useFailedCount((state) => state.count);

  return (
    <div className='flex w-3/5 rounded-xl bg-white p-4 py-10 opacity-50 transition-colors duration-300 dark:bg-gray-800 fixed mt-96'>
