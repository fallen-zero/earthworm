          ...
          <div className='flex items-center justify-center gap-2'>
            <div className='relative'>
              ...
              <div className='opacity-0 bottom-full pb-2 pointer-events-none absolute left-1/2 flex -translate-x-1/2 transform items-center justify-center transition-opacity'>
                <span className='tooltip'>错题本</span>
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <g
                      ...
                      clipRule='evenodd'
                    >
                      <path d='M2.25 13.5a8.25 8.25 0 0 1 8.25-8.25a.75.75 0 0 1 .75.75v6.75H18a.75.75 0 0 1 .75.75a8.25 8.25 0 0 1-16.5 0Z'></path>
                      <path d='M12.75 3a.75.75 0 0 1 .75-.75a8.25 8.25 0 0 1 8.25 8.25a.75.75 0 0 1-.75.75h-7.5a.75.75 0 0 1-.75-.75V3Z'></path>
                    </g>
                  </svg>
                </button>
              </div>
              <div className='opacity-0 bottom-full pb-2 pointer-events-none absolute left-1/2 flex -translate-x-1/2 transform items-center justify-center transition-opacity'>
                <span className='tooltip'>查看数据统计</span>
              </div>
            </div>
          </div>
        </nav>
